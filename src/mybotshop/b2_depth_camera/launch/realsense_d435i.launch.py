...
configurable_parameters = [{'name': 'camera_namespace',             'default': nsp, 'description': 'namespace for camera'},
                           {'name': 'camera_name',                  'default': nsp, 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '1920,1080,8', 'description': 'color stream profile'},
...
def generate_launch_description():
    ...
    parameters = declare_configurable_parameters(configurable_parameters)

    ld = LaunchDescription()

    # Add the environment variable setting
    ld.add_action(b2_control_domain_id)

    # Add each parameter declaration individually
    for param in parameters:
        ld.add_action(param)

    # Add the realsense node
