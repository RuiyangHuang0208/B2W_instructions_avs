...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('b2_nav2')
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            Node(
                ...
                remappings=rmp + [('cmd_vel', 'cmd_vel_nav')]),
            Node(
                namespace=nsp,
            ...
            Node(
                ...
                arguments=['--ros-args', '--log-level', log_level],
                remappings=rmp +
                        [('cmd_vel', 'cmd_vel_nav'), ('cmd_vel_smoothed', 'autonomous_low_priority/cmd_vel')]),
            Node(
                namespace=nsp,
                remappings=rmp,
