...
```bash
ROS_DOMAIN_ID=10 ros2 run nav2_map_server map_saver_cli -f /opt/mybotshop/src/mybotshop/b2_nav2/maps/custom_map --ros-args --remap   map:=/b2_366/map
ROS_DOMAIN_ID=10 ros2 run nav2_map_server map_saver_cli -f /opt/mybotshop/src/mybotshop/b2_nav2/maps/custom_map_2 --ros-args --remap map:=/b2_366/map
```
...
```bash
ros2 launch b2_nav2 localization.launch.py
```
